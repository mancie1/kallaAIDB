                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        ...
                        <?php foreach ($laboratorists as $laboratorist) { ?>
                            <tr class="">
                                ...
                                <td>
                                    <a class="" href="laboratorist/editLaboratorist?id=<?php echo $laboratorist->id; ?>"><i class="fa fa-edit"></i></a>
                                    <a class="" href="laboratorist/delete?id=<?php echo $laboratorist->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-times"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
