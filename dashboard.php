...
<html lang="en">
    <head>
        ...
        <title><?php echo $this->router->fetch_class(); ?> | SIR YAHAYA MEMORIAL HOSPITAL</title>
        <!-- Bootstrap core CSS -->
    ...
    <body>
        ...
        <section id="container" class="">
            ...
            <header class="header white-bg">
                ...
                <!--logo start-->
                <a href="" class="logo">SIR YAHAYA<span>HOSPITAL</span></a>
                <!--logo end-->
                            ...
                            <li class="dropdown">
                                <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                    ...
                                    <span class="badge bg-success">  
                                        ...
                                        if (!empty($data)) {
                                            echo $available_bed = array_sum($data);
                                        } else {
                                            $available_bed = 0;
                                            echo $available_bed;
                                        }
